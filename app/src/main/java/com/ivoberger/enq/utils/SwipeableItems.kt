...
fun setupSwipeActions(
    ...
    val drawableLeft = context.icon(iconLeft).color(context.onSecondaryColor()).sizeDp(24)
    val touchCallback =
    ...
    if (iconRight != null && colorRight != null) {
        val drawableRight = context.icon(iconRight).color(context.onSecondaryColor()).sizeDp(24)
